...
from slog.ende_zu_ende.don_informed_keypointnet import DONInformedKeypointNetConfig, DONInformedKeypointNet, DataModuleDONInformedKeypointNet

from slog.utils import initialize_config_file


class DONInformedKeypointnetTrainer:
    ...
    def __init__(self, yaml_config_path: str) -> None:
        ...
        self.datamodule = DataModuleDONInformedKeypointNet(yaml_config_path)
        self.datamodule.prepare_data()
        self.datamodule.setup()
        self.model = DONInformedKeypointNet(yaml_config_path)
    ...
    @staticmethod
    def _generate_model_name(config: DONInformedKeypointNetConfig) -> str:
        ...
        return f"DIK-{don_details}-{keypoint_details}"
